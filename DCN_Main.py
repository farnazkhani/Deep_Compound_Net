...
import sys
sys.path.append('/content/drive/My Drive/Khani/multi_DTI/integrateMV.py')
sys.path.insert(0,'/content/drive/My Drive/Khani/multi_DTI/integrateMV.py')
...
#!ls /content/drive/My\ Drive/Khani/multi_DTI/*.py
#!cat '/content/drive/My Drive/Khani/multi_DTI/integrateMV.py'
import integrateMV as MV
...
#def main():
    ...
    #parser = arg.ArgumentParser(description ='CNN_n2v')
        args ={'gpu','batchsize'}
    ...
    #parser.add_argument('--output', '-o', default='./result/dataset_hard')
    ...
    #parser.add_argument('--st2', type=int, default=1)
        self.st2 = 1
    #parser.add_argument('--k3', type=int, default=11)
        self.k3 = 4
    #parser.add_argument('--st3', type=int, default=1)
        self.st3 = 1
    #parser.add_argument('--f3', type=int, default=64)
        self.f3 = 100
    #parser.add_argument('--k4', type=int, default=5)
        self.k4 =4
    #parser.add_argument('--st4', type=int, default=1)
        self.st4 = 1
    #parser.add_argument('--k5', type=int, default=11)
        self.k5 =4
    #parser.add_argument('--st5', type=int, default=1)
        self.st5 = 1
    #parser.add_argument('--f5', type=int, default=128)
        self.f5 = 100
    #parser.add_argument('--k6', type=int, default=5)
        self.k6 = 4
    #parser.add_argument('--st6', type=int, default=1)
        self.st6 = 1
    #parser.add_argument('--n_out_com', type=int,default='./result/dataset_hard')
        self.n_out_com = 1
    #parser.add_argument('--n_hid6', type=int, default=60)
        self.n_hid6 = 100
    #parser.add_argument('--n_hid7', type=int, default=70)
        self.n_hid7 = 100
        self.frequency=100
args = o()   
...
for j in range(5):
    ...
    for i in range(5):
        ...
        gc.collect()
        import pandas as pd
        #file_smiles=pd.read_csv(path_data+'dataset_hard'+'/cv_'+str(i)+'/train.smiles.csv')
        ...
        #train_dataset = datasets.TupleDataset(np.expand_dims(smiles,axis=-1), np.expand_dims(sequences,axis=-1), n2vc[0:500,:], n2vp[0:500,:], interactions[0:500,:])
